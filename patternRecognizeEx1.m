...
g1=-0.5*(x-mu11)*sigmaInv*transpose(x-mu11)-0.5*log(detSigma)+log(p1);
g2=-0.5*(x-mu22)*sigmaInv*transpose(x-mu22)-0.5*log(detSigma)+log(p2);
g3=-0.5*(x-mu33)*sigmaInv*transpose(x-mu33)-0.5*log(detSigma)+log(p3);
...
%    (-0.5*([x1 x2]-mu33)*sig3Inv*([x1 x2]-mu33)'-0.5*log(det3)+log(p3))
g12=-0.5*([x1 x2]-mu11)*sigmaInv*([x1 x2]-mu11)'-0.5*log(detSigma)+log(p1)-...
    (-0.5*([x1 x2]-mu22)*sigmaInv*([x1 x2]-mu22)'-0.5*log(detSigma)+log(p2))
g13=-0.5*([x1 x2]-mu11)*sigmaInv*([x1 x2]-mu11)'-0.5*log(detSigma)+log(p1)-...
    (-0.5*([x1 x2]-mu33)*sigmaInv*([x1 x2]-mu33)'-0.5*log(detSigma)+log(p3))
g23=-0.5*([x1 x2]-mu22)*sigmaInv*([x1 x2]-mu22)'-0.5*log(detSigma)+log(p2)-...
    (-0.5*([x1 x2]-mu33)*sigmaInv*([x1 x2]-mu33)'-0.5*log(detSigma)+log(p3))
